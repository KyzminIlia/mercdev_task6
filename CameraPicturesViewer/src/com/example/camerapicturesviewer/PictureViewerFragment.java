...
public class PictureViewerFragment extends Fragment implements
		TwoWayAdapterView.OnItemClickListener {
	public static final String FRAGMENT_TAG = PictureViewerFragment.class
			.getSimpleName();
	...
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		pictureGridView = (TwoWayGridView) view
				.findViewById(R.id.pictures_grid);
	...
	public void onItemClick(TwoWayAdapterView<?> parent, View view,
		...
		intent.setDataAndType(
				Uri.parse("file://"
						+ ((String) (pictureGridView.getAdapter()
